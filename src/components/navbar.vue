...
<template>
  <div class="h-16 bg-orange-700 dark:bg-black flex justify-between items-center text-white px-96">
    ...
    <div class="flex justify-between space-x-4">
      <button class="hover:scale-110 transition-all ease-out hover:cursor-pointer" @click="toggleDark()">
        <svg
          ...
          viewBox="0 0 128 128"
        >
          <path fill="#FCC11A" d="M37.41 41.95c-9.71 12.48-9.54 34.65 2.87 45.64c14.09 12.47 33.92 12.34 46.39.87c14.95-13.76 14.09-36.66.87-49.63c-13.29-13.04-37.04-13.72-50.13 3.12"></path>
          <path fill="#FEE269" d="M53 37.67c-3.84-1.7-8.04 2.93-9.87 6.09c-1.83 3.17-3.53 9.38.37 10.97c3.9 1.58 6.7-1.1 9.51-5.73c2.79-4.63 4.38-9.38-.01-11.33"></path>
          <path
            fill="#FFA722"
